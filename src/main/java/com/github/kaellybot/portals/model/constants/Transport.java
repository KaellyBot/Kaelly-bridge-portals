...
public enum Transport {
    ...
    ZAAP_BRAKMAR                  (ZAAP        , CENTRE_BRAKMAR             , Position.of(-26,35)  , true ),
    FOREUSE_LABORATOIRE_ABANDONNE (FOREUSE     , LABORATOIRES_ABANDONNES    , Position.of(27,-14)  , true ),
    FOREUSE_PANDALA_NEUTRE        (FOREUSE     , PANDALA_NEUTRE             , Position.of(28,-30)  , true ),
    FOREUSE_PLAGE_MOON            (FOREUSE     , PLAGE_TORTUE               , Position.of(36,4)    , true ),
    FOREUSE_FEUILLAGE_ARBRE_HAKAM (FOREUSE     , FEUILLAGE_ARBRE_HAKAM      , Position.of(-53,17)  , true ),
    FOREUSE_MINE_MAKSAGE          (FOREUSE     , FORET_PINS_PERDUS          , Position.of(-55,-64) , true ),
    FOREUSE_MILIFUTAIE            (FOREUSE     , MILLIFUTAIE                , Position.of(2,4)     , true ),
    FOREUSE_KARTONPATH            (FOREUSE     , TUNNEL_KARTONPATH          , Position.of(18, 11)  , true ),
    FOREUSE_TERRITOIRE_PORCOS     (FOREUSE     , TERRITOIRE_PORCOS          , Position.of(0,33)    , true ),
    FOREUSE_BAIE_CANIA            (FOREUSE     , BAIE_CANIA                 , Position.of(-29,-12) , true ),
    FOREUSE_GROTTE_HURIE          (FOREUSE     , VALLEE_MORH_KITU           , Position.of(-18,14)  , true ),
    FOREUSE_MINE_HERALE           (FOREUSE     , FORET_AMAKNA               , Position.of(5,19)    , true ),
    FOREUSE_MINE_ISTAIRAMEUR      (FOREUSE     , MONTAGNE_BASSE_CRAQUELEURS , Position.of(-3,9)    , true ),
    FOREUSE_MINE_HIPOUCE          (FOREUSE     , MINE_HIPOUCE               , Position.of(-23,25)  , true ),
    FOREUSE_DENTS_PIERRE          (FOREUSE     , DENTS_PIERRE               , Position.of(-4,-53)  , true ),
    ...
    BRIGANDIN_RIVIERE_KAWAII      (BRIGANDIN   , RIVIERE_KAWAII             , Position.of(6,-1)    , true ),
    BRIGANDIN_PORTE_BONTA         (BRIGANDIN   , PORTE_BONTA                , Position.of(-31,-48) , true ),
    BRIGANDIN_PORTE_BRAKMAR       (BRIGANDIN   , PORTE_BRAKMAR              , Position.of(-26,29)  , true ),
    BRIGANDIN_VILLAGE_BWORKS      (BRIGANDIN   , VILLAGE_BWORKS             , Position.of(-1,8)    , true ),
    BRIGANDIN_PRESQUILE_DRAGOEUFS (BRIGANDIN   , PRESQUILE_DRAGOEUF         , Position.of(-3,27)   , true ),
    BRIGANDIN_VILLAGE_BRIGANDINS  (BRIGANDIN   , VILLAGE_BRIGANDINS         , Position.of(-17,-26) , true ),
    BRIGANDIN_PENINSULE_GELEES    (BRIGANDIN   , PENINSULE_GELEES           , Position.of(11,30)   , true ),
    BRIGANDIN_PANDALA             (BRIGANDIN   , PANDALA_NEUTRE             , Position.of(18,-39)  , true ),
    BRIGANDIN_ILE_MINOTOROR       (BRIGANDIN   , ILE_MINOTOROR              , Position.of(-41,-18) , true ),
    BRIGANDIN_ILE_MOON            (BRIGANDIN   , PLAGE_TORTUE               , Position.of(35,4)    , true ),
    BRIGANDIN_ILE_WABBITS         (BRIGANDIN   , ILE_CAWOTTE                , Position.of(23,-3)   , true ),
    BRIGANDIN_VILLAGE_ZOTHS       (BRIGANDIN   , VILLAGE_ZOTHS              , Position.of(-53,15)  , true ),
    ...
    SCAEROPLANE_ARBRE_HAKAM       (SCAEROPLANE , ARBRE_HAKAM                , Position.of(-54,19)  , false),
